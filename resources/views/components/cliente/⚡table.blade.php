        ...
        <flux:card>
            <flux:table :paginate="$this->clientes">
                <flux:table.columns>
                    ...
                    <x-header-table icon="user-round" sortable="nombre" :sortBy="$sortBy"
                        :sortDirection="$sortDirection">Nombre</x-header-table>
                    <x-header-table sortable="apellido_paterno" :sortBy="$sortBy"
                        :sortDirection="$sortDirection">Apellido Paterno</x-header-table>
                    <x-header-table sortable="apellido_materno" :sortBy="$sortBy"
                        :sortDirection="$sortDirection">Apellido Materno</x-header-table>
