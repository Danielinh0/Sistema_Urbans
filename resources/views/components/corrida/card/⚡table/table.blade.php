                            ...
                            @can('update', $corrida)
                                {{-- <flux:table.cell align="center">
                                    <div class="flex items-center gap-2 w-full justify-center">
                                        ...
                                        <flux:button size="xs" icon="navigation" class="bg-fondo-amarillo! text-texto-fondo!
                                        ...
                                        <flux:button size="xs" variant="ghost" icon="map-pin-off" class="bg-fondo-rojo! text-texto-rojo!
                                ...
                                <flux:table.cell>
                                    <div class="flex gap-4">
                                        ...
                                        <flux:button size="sm" variant="ghost" icon="trash"
                                            class="bg-fondo-rojo! text-texto-rojo! hover:bg-texto-rojo! hover:text-white! border-none! btn-animado"
                                            wire:click="$dispatch('eliminacion-corrida', { id: {{ $corrida->id_corrida }} })">
                                        </flux:button>
